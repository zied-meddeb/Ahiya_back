...
export const fournisseurService = {
    ...
    createFournisseur: async (userData: Partial<IFournisseur>): Promise<FournisseurResponse> => {
        try {
            ...
            await fournisseurService.sendVerificationEmail(userData.email, verificationCode);
    ...
    verifyEmail: async (email: string, code: string): Promise<FournisseurResponse> => {
      ...
      sendVerificationEmail: async (email: string, verificationCode: string): Promise<FournisseurResponse> => {
            try {

...
ProduitController.post('/', verifyToken, async (req: Request, res: Response) => {
    try {
...
ProduitController.put('/:id', verifyToken, async (req: Request, res: Response) => {
    try {
...
ProduitController.delete('/:id', verifyToken, async (req: Request, res: Response) => {
    try {
...
ProduitController.get('/search/criteria', async (req: Request, res: Response) => {
    try {
...
ProduitController.get('/category/:categoryId', async (req: Request, res: Response) => {
    try {
...
ProduitController.get('/search/popular', async (req: Request, res: Response) => {
    try {
        const limit = parseInt(req.query.limit as string) || 10;
...
ProduitController.get('/byfournisseur/:fournisseurId', async (req: Request, res: Response) => {
    try {
...
ProduitController.get('/current-promotions', async (req: Request, res: Response) => {
    try {

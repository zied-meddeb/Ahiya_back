...
ProduitController.post("/", middleware_1.verifyToken, (0, upload_1.uploadImageToCloudinary)("image"), async (req, res) => {
    try {
...
ProduitController.put("/:id", middleware_1.verifyToken, (0, upload_1.uploadImageToCloudinary)("image"), async (req, res) => {
    try {
        if (req.uploadedImageUrl) {
            req.body.imageUrl = req.uploadedImageUrl;
        }
